...
const testimonials = [
  ...
  },
  {
    ...
    role: "Data Analyst",
    text: "Thank you, Classbot, for providing an affordable application with excellent student Data management and fee management features perfect for our coaching institute!",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT1x_1ueYyzVI5MQ8SZMG6iKA7w-EpP_Q6riA&s",
  },
  {
    name: "Mohit Gupta",
    role: "Data Analyst",
  ...
  return (
    <div className="w-full flex items-center justify-center bg-white px-4 py-12">
      <div className="max-w-6xl w-full">
        <h2 className="text-3xl md:text-6xl font-bold mb-1 bg-primary">
          Why People  
        </h2>
        ...
        <div className="relative overflow-hidden">
          <div
            ref={sliderRef}
            className="flex gap-6 flex-nowrap pb-4 p-3 snap-x snap-mandatory scroll-smooth overflow-x-scroll [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
          >
            {testimonials.map((item, index) => (
              <div
                ...
                border rounded-xl p-4 pl-5 pt-13 flex flex-col shadow-sm bg-white transition-all
                ${
                  active === index
                ...
                <div className="flex align-items-end gap-6 mt-2">
                  ...
                  <div className="flex flex-col justify-between h-full">
                   ...
                   <div className="inline-flex flex-col items-center self-end leading-none">
                      <p className="text-lg italic text-black m-0 font-bold mt-5">
                        {item.name}
                      </p>
                      <p className="text-sm md:text-md font-semibold text-black m-0 italic">
                        {item.role}
                      </p>
                    </div>
                  </div>
